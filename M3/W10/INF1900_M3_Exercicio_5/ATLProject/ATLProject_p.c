...
/* Object interface: ICalculator, ver. 0.0,
   GUID={0x599a38f6,0x0608,0x421c,{0x80,0xa3,0xd9,0x91,0x5d,0xd1,0xf3,0xc4}} */
...
/* ApproximatePi */
    { 
    /* ApproximatePi */      /* procedure ApproximatePi */
...
CINTERFACE_PROXY_VTABLE(4) _ICalculatorProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* ICalculator::ApproximatePi */
};
...
EXTERN_C const ExtendedProxyFileInfo ATLProject_ProxyFileInfo = 
{
